...
public class Http {
    ...
    /**
     * Parses a http range header returning an array the range values
     * Examples: "range=1000-2000" returns { 1000, 2000 }
     * "range=1000-" returns { 1000, Integer.MAX_VALUE }
     * If the input is malformed, it returns {0,0} or something unpredictable
     */
	...
	if (upperSide.isEmpty() ) result[1]=Integer.MAX_VALUE-1;
