...
public class Http {
	...
	/**
	 * Parses an HTTP range header sent by a client returning an array the range values
...
//		System.out.println("range from: "+result[0]+" to "+result[1]);
	...
	/**
	 * Parses an HTTP range header sent by a server returning an array with the range values
	 * as well as the size of the file
	 * Examples: "range 1000-2000/3000" returns { 1000, 2000, 3000 }
